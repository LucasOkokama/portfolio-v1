  ...
  return (
    ...
    >
      ...
      >
        {/* Banner Tag */}
        <span
          className={`absolute right-4 top-3 z-[2] bg-[#fffb01] px-2 py-1 text-black`}
        >
          NOVO
        </span>
        {/* Banner IMG */}
      ...
      <div className="flex flex-col gap-4 px-5 py-4 text-[#8f8f8f]">
        <div>
          ...
          {/* Content Title */}
          <h1
            className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} mt-4 cursor-pointer duration-300`}
          >
          ...
          {/* Content Intro text */}
          <p
            className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} mt-3`}
          >
            ...
            >
              {stats.map((item, index) =>
                index != 1 ? (
                  ...
                  <div
                    key={index}
                    className={`${theme === "light" ? "" : ""} flex cursor-pointer items-center justify-end gap-[4px] duration-200`}
                  >
                    <span
