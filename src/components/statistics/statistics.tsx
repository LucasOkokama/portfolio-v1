...
import InfinityTechCarousel from "./infinity-tech-carousel";
        ...
        <div className="flex w-full gap-4">
          {statsInfo.map((stat, index) => (
            ...
            >
              ...
              {/* Stats values */}
              <div
                className={`${lexend.className} whitespace-nowrap text-[26px] font-semibold`}
