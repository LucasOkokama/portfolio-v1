...
export default function Base() {
  ...
  return (
    <div
      className={`${theme === "light" ? "border-neutral-700 bg-[#ffffff]" : "border-neutral-700/80 bg-[#14181C]"} z-[2] h-full w-full overflow-auto border font-serif`}
    >
      {/* Banner */}
      <div
      ...
      <div className="text-[#8f8f8f]">
        <div>
          ...
          {/* Content Tags */}
          <div
            className={`${theme === "light" ? "text-[#134aff]" : "text-[#134aff]"}`}
          >
            <div className="">
              {tags.map((tag, index) => (
            ...
            >
              {stats.map((item, index) =>
                index != 1 ? (
                  ...
                  <div
                    key={index}
                    className={`${theme === "light" ? "" : ""} duration-200`}
                  >
                    <span
