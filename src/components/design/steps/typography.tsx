  ...
  return (
    ...
    >
      ...
      >
        {/* Banner Tag */}
        <span
          className={`${lexend.className} absolute right-4 top-3 z-[2] bg-[#fffb01] px-2 py-1 text-sm font-bold text-black`}
        >
          NOVO
        </span>
        {/* Banner IMG */}
      ...
      {/* Content */}
      <div className="flex flex-col gap-4 px-5 py-4 text-[#8f8f8f]">
        <div>
          {/* Content Tag & Publish date */}
          <div className={`${poppins.className} flex justify-between text-sm`}>
            {/* Content Tag */}
            <h3
              className={`${theme === "light" ? "text-[#ff0e0e]" : "text-[#ff0e0e]"} font-semibold tracking-widest`}
            >
              FILME
            </h3>
          ...
          {/* Content Title */}
          <h1
            className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} ${lexend.className} mt-4 cursor-pointer text-[22px] duration-300`}
          >
          ...
          {/* Content Intro text */}
          <p
            className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} ${poppins.className} mt-3 text-sm font-light leading-[28px]`}
          >
          ...
          >
            ...
            {/* Like button */}
            <div
              className={`${handleLikeButton()} ${theme === "light" ? "bg-[#858585]" : "bg-[#8b8b8b]"} p-[6px] duration-300`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
        ...
        <div className="flex gap-3">
          ...
          <div className="flex w-full overflow-hidden">
            ...
            <div className={`${urbanist.className} w-full`}>
              <a href="https://www.imdb.com/name/nm0799777/" target="_blank">
                <h4
                  className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} font-semibold duration-300`}
                >
                  J. Jonah Jameson
                </h4>
              </a>
            ...
            {/* Stats */}
            <div
              className={`${theme === "light" ? "text-[#000000]" : "text-[#ffffff]"} flex h-full flex-col justify-center gap-1 pr-1`}
            >
